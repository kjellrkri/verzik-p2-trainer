...
var unlimited_hp_enabled = localStorage.getItem(unlimited_hp_storage_key) === "true";
...
const default_custom_tile_markers = {
    ...
    "11,6": {"color":"#37ff00","label":"1"},
    "12,8": {"color":"#59ff00","label":"2"},
    "11,8": {"color":"#37ff00","label":"6"},
    "7,8": {"color":"#ffff00","label":""},
    "10,9": {"color":"#00ff4c","label":"3"},
    "8,8": {"color":"#2bff00","label":"4"},
    "10,10": {"color":"#59ff00","label":"5"},
